...
{
    public class RemoveItemsNotMatchingNextItemWithStepTests
    {
        [Theory]
        ...
        {
            Assert.Equal(expected, numbers.RemoveItemsNotMatchingNextItem());
        }
        ...
        {
            Assert.Equal(expected, numbers.RemoveItemsNotMatchingHalfwayAroundItem());
        }
